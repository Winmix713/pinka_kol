...
import { CONNECTION_QUALITY_THRESHOLDS } from "@/utils/validation"
  ...
  const completeConnection = useCallback(
    (success: boolean, error?: string) => {
      ...
      if (success) {
        ...
        if (responseTime > CONNECTION_QUALITY_THRESHOLDS.GOOD) connectionQuality = "poor"
        else if (responseTime > CONNECTION_QUALITY_THRESHOLDS.EXCELLENT) connectionQuality = "good"
